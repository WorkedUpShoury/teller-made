// =============================
// ResumeBuilder.jsx (FULL, with Transitions and Full Functionality)
// =============================
    ...
    <div className="rb-page">
      ...
      <div className="rb-root">
        <header className="rb-header">
            <div className="rb-header-inner"><div className="rb-title"><span className="rb-badge" aria-hidden="true"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="white" strokeWidth="2"><circle cx="12" cy="12" r="4" /><path d="M3 12h3M18 12h3M12 3v3M12 18v3" /></svg></span><span>Resume Builder</span></div><div className="rb-actions"><button className="rb-btn" disabled={loading} onClick={exportJSON} title="Download JSON">⭳ JSON</button><button className="rb-btn" disabled={loading} onClick={exportLaTeX} title="Download LaTeX">.tex</button><button className="rb-btn primary" disabled={!requiredOk || loading} onClick={exportPDF} title="Download PDF">PDF</button></div></div>
        </header>
